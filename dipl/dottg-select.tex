...
% figure - picture
    ...
    \begin{center}
        ...
        \large{(Master thesis)}
        \vskip 0.5cm
        \textbf{\large bc. Frantiöek HajnoviË}
        \begin{center} \line(1,0){350} \end{center}
    ...
    \textbf{Supervisor}: doc. RNDr. Rastislav Kr·loviË, PhD.   \hfill Bratislava 2013
    ...
    I would like to thank very much to my supervisor Rastislav Kr·loviË for valuable remarks, useful advices and consultations that helped me stay on the right path during my work on this thesis.
    
    \hspace{40pt} I am also grateful for the support of my family during my studies and the work on this thesis.

	\vspace{1cm}    
    
    \hspace{\fill} \textit{Frantiöek HajnoviË}
    ...
    \begin{abstract}{Abstrakt}
        V tejto pr·ci sa zaober·me hæadanÌm optim·lnych spojenÌ v cestovn˝ch poriadkoch, na ktor˝ch sme si predpoËÌtali urËitÈ inform·cie. Na z·klade anal˝zy re·lnych cestovn˝ch poriadkov sme vyvinuli exaktnÈ metÛdy, ktorÈ na dotaz na optim·lne spojenie odpovedaj˙ podstatne r˝chlejöie ako Ëasovo z·visl· implement·cia Dijkstrovho algoritmu vyuûÌvaj˙ca prioritn˙ frontu na z·klade Fibonacciho haldy. Presnejöie, n·ö algoritmus \textit{USP-OR-A} s priestorovou zloûitosùou $\mathcal{O}(n^{1.5})$ dosahuje Ëasov˙ zloûitosù odpovede na dotaz $\mathcal{O}(\sqrt{n} \log n)$, prekon·vaj˙c Ëasovo z·visl˝ Dijkstrov algoritmus takmer 7 kr·t v naöom najv‰Ëöom cestovnom poriadku. \\

		Kl˙ËovÈ slov·: \textbf{optim·lne spojenie}, \textbf{cestovn˝ poriadok}, \textbf{Dijkstrov algoritmus}, \textbf{DiötanËnÈ or·kul·}, \textbf{podkladovÈ najkratöie cesty}
	\end{abstract}	
