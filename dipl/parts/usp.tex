...
\subsection{Performance and comparisons}
	...
	\subsubsection{Performance of \textit{USP-OR}}
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{gb-coach}}} dataset. \textbf{Changing $\bm{n}$}.}
	    ...
	    \begin{minipage}{0.45\textwidth}  
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{cpsk-d}}} dataset. \textbf{Changing $\bm{n}$}.}
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{gb-train-d}}} dataset. \textbf{Changing $\bm{n}$}.}
		    \label{plot:uspor-gbtr-d-size}  
	    \end{minipage}
	    }
		\end{figure}
		
		\noindent From plots~\ref{plot:uspors-gbcoach-200-trange} and~\ref{plot:uspors-air01-200-trange} we see that the time range does not play a role in the query time of neither TD Dijkstra, nor \textit{USP-OR-A}.
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{gb-coach-200}}} dataset. \textbf{Changing $\bm{tr}$} (days).}
		    \label{plot:uspors-gbcoach-200-trange}   
	    \end{minipage}
		\hspace{1cm}
	    \begin{minipage}{0.45\textwidth} 
	    	\centering
		    \inputTikZ{./tikzpics/plot_uspor_air01-200_trange}
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR} algorithm compared to TD Dijkstra on the \textit{\textbf{air01-200}} dataset. \textbf{Changing $\bm{tr}$} (days).}
		    \label{plot:uspors-air01-200-trange}   
	    \end{minipage}
	    }
		\end{figure}
	...
	\subsubsection{\textit{USP-OR-A}}
	    ...
	    \begin{minipage}{0.45\textwidth} 
			...
			%data
				...
				\textit{sncf-inter-w} & 366 & \textbf{4.9} & 0.8 \\
				\textit{sncf-ter-w} & 2637 & \textbf{5.6} & 3.0 \\
				\textit{zsr-d} & 233 & 2.6 & 0.7 \\
			\end{tabular}
	    \end{minipage}
	    }
	    ...
	    \begin{minipage}{0.45\textwidth}  
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR-A} algorithm compared to TD Dijkstra on the \textit{\textbf{sncf}} dataset. \textbf{Changing $\bm{n}$}.}
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR-A} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{gb-coach}}} dataset. \textbf{Changing $\bm{n}$}.}
	    ...
	    \begin{minipage}{0.45\textwidth}  
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR-A} algorithm compared to TD Dijkstra on the \textit{\textbf{cpsk-d}} dataset. \textbf{Changing $\bm{n}$}.}
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR-A} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{gb-train-d}}} dataset. \textbf{Changing $\bm{n}$}.}
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR-A} algorithm compared to TD Dijkstra on the \mbox{\textit{\textbf{gb-coach}}} dataset. \textbf{Changing $\bm{tr}$} (days).}
		    \label{plot:usporas-gbcoach-trange}   
	    \end{minipage}
		\hspace{1cm}
	    \begin{minipage}{0.45\textwidth} 
	    	\centering
		    \inputTikZ{./tikzpics/plot_uspora_zsr_trange}
		    \captionof{figure}{\textbf{Query time} of \textit{USP-OR-A} algorithm compared to TD Dijkstra on the \textit{\textbf{zsr}} dataset. \textbf{Changing $\bm{tr}$} (days).}
