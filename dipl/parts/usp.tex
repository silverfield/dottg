...
\subsection{\textit{USP-OR}}
	...
	\subsubsection{Analysis of \textit{USP-OR}}	
		...
		\begin{table}[H]
			...
			%data
				\hline
				\textit{air01-200d} & 7.5 & 35 & 3.8 \\
				\textit{cpsk-200d} & 12.1 & 67 & 19.3 \\
				\textit{gb-coach-200d} & 5.3 & 48 & 7.3 \\
				\textit{gb-train-200d} & 10.3 & 72 & 10.7 \\
				\textit{montr-200d} & 5.1 & 34 & 28.6 \\
				\textit{sncf-200d} & 5.6 & 25 & 10.7 \\
				\textit{sncf-ter-200d} & 5.6 & 22 & 15.5 \\
				\textit{sncf-inter-200d} & 2.6 & 17 & 15.6 \\
				\textit{zsr-200d} & 3.7 & 22 & 17.0 \\
			\end{tabular}
			\captionof{table}{Average and maximal USP coefficients for daily timetables with 200 stations ($\sqrt{200} \approx 14$).}
			\label{tab:usp200}
		\end{table}	
	    ...
	    \begin{minipage}{0.45\textwidth} 
		    ...
		    \captionof{figure}{Changing of $\omega$ with increased number of stations in \textit{cpsk} dataset.}
