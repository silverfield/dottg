	...
	\subsubsection{\textit{USP-OR-A}}
	    ...
	    \begin{minipage}{0.45\textwidth}  
			...
			%data
				...
				\textit{air01-d} & 284 &  &  \\
				\textit{cpsk-d} & 1905 &  &  \\
				\textit{gb-coach-d} & 2427 &  &  \\
				\textit{gb-train-d} & 2550 &  &  \\
				\textit{montr-d} & 217 &  &  \\
				\textit{sncf-d} & 2608 &  &  \\
				\textit{sncf-inter-d} & 344 &  &  \\
				\textit{sncf-ter-d} & 2600 &  &  \\
				\textit{zsr-d} & 225 &  &  \\
			\end{tabular}
	    \end{minipage}
		\hspace{1cm}
	    \begin{minipage}{0.45\textwidth} 
			...
			%data
				\hline
				\textit{air01-w} & 287 &  &  \\
				\textit{gb-coach-w} & 2448 &  &  \\
				\textit{gb-train-w} & 2555 &  &  \\
				\textit{sncf-w} & 2646 &  &  \\
				\textit{sncf-inter-w} & 366 &  &  \\
				\textit{sncf-ter-w} & 2637 &  &  \\
				\textit{zsr-d} & 233 &  &  \\
			\end{tabular}
	    \end{minipage}
	    }
	    \captionof{table}{Speed-ups and size-ups of the \textit{USP-OR-A} with \textit{locsep} for the whole timetables .}
