        ...
        \end{frame}
            ...
            \begin{frame}
                ...
                \begin{itemize}
                    ...
                    \end{itemize}
                    \item<3-> Predrátanie cez \textbf{Floyd–Warshallov} algoritmus a uloenie do tabu¾ky
                    \begin{itemize}
                        \item<4-> \emph{Preprocessing} = $\mathcal{O}(n^3)$, \emph{Size} = $\mathcal{O}(n^2)$, \emph{Query time} = $\mathcal{O}(1)$, \emph{Stretch} = 1
                    \end{itemize}
                    \item<5-> Cestná sie Európy má cca \emph{20 000 000} vrcholov (kriovatiek) ~\cite{hwhierarchies05}
...
%---------------------------------------------------------------------
    ...
    \begin{frame}
        ...
        \begin{itemize}
            ...
            \item<3-> Pre grafy so elanou vlastnosou existuje efektívny algoritmus na h¾adanie najkratších ciest $\rightarrow$ vieme ho \emph{upravi pre expandované grafy}?
    ...
    \end{frame}
        ...
        \subsection{Highway dimension}
            ...
            \begin{frame}
                ...
                \begin{itemize}
                    \item<1-> Malá mnoina \emph{tranzitnıch bodov} (\textbf{transit nodes}), medzi ktorımi si predrátame vzdialenosti
                    \item<2-> Pre kadı vrchol - mnoina \emph{prístupovıch bodov} (\textbf{access nodes}). Opä predrátané vzdialenosti
            ...
            \begin{frame}
                ...
                \begin{itemize}
                    ...
                    \begin{itemize}
                        ...
                        \item<6-> \textbf{Time-dependent CH} \cite{timedepch09} ve¾ká pamäová nároènos
                    \end{itemize}    
                \end{itemize}
            \end{frame}
        ...
        \subsection{Vıskum}
            ...
            \begin{frame}
                ...
                \end{table}
                \begin{itemize}
                    \item<2-> Vlastnosti cestovnıch poriadkov budú \emph{zálea} od toho:
                    \begin{itemize}
    ...
    \end{frame}
        ...
        \begin{frame}
            ...
            \begin{itemize}
                ...
                \end{itemize}
                \item<7-> C++ - kód
                \item<8-> Pyhton - parsovanie vstupov
            \end{itemize}
        \end{frame}
